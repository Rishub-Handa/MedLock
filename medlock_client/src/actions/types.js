...
export const DELETE_ALL_PATIENTS_BEGIN = 'DELETE_ALL_PATIENTS_BEGIN';
export const DELETE_ALL_PATIENTS_SUCCESS = 'DELETE_ALL_PATIENTS_SUCCESS';
export const DELETE_ALL_PATIENTS_FAILURE = 'DELETE_ALL_PATIENTS_FAILURE';
